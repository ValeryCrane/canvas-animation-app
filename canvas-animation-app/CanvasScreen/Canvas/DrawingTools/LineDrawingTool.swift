...
struct LineStroke: DrawingToolStroke {
    func draw(inContext context: CGContext) {
        LineDrawingTool.drawStroke(self, inContext: context)
    }
...
final class LineDrawingTool: DrawingTool {
    typealias Stroke = LineStroke
    
    static func drawStroke(_ stroke: LineStroke, inContext context: CGContext) {
